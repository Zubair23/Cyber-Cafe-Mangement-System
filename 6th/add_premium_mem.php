            ...
            <div class="row">
                <form action="inc/query.php" method="POST">
				  ...
				  <div class="form-group">
					...
					<input type="date" class="form-control" id="sub_time" placeholder="Subscription Time" name="sub_time" >
				  </div>
				  <div class="form-group">
					<label for="reg_date">Registration Date</label>
					<input type="text" class="form-control" id="reg_date" value="<?php echo date('Y-m-d');?>" name="reg_date" disabled>
				  </div>
				  <div class="form-group">
